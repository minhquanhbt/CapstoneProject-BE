...
class VocabularySeeder extends Seeder
{
    ...
    {
        // 1
        $vocabulary = Vocabulary::insertGetId(['word' => '中日','pronouce' => 'ちゅうにち', 'level' => 5]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 2
        $vocabulary = Vocabulary::insertGetId(['word' => '一月','pronouce' => 'いちがつ', 'level' => 5]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 3
        $vocabulary = Vocabulary::insertGetId(['word' => '中国','pronouce' => 'くにびと', 'level' => 5]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 4
        $vocabulary = Vocabulary::insertGetId(['word' => '人出','pronouce' => 'ひとで', 'level' => 5]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 5
        $vocabulary = Vocabulary::insertGetId(['word' => '今年','pronouce' => 'ことし / こんねん', 'level' => 5]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 6
        $vocabulary = Vocabulary::insertGetId(['word' => '五月','pronouce' => 'さつき / ごがつ', 'level' => 5]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 7
        $vocabulary = Vocabulary::insertGetId(['word' => '医大','pronouce' => 'いだい', 'level' => 4]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 8
        $vocabulary = Vocabulary::insertGetId(['word' => '丸本','pronouce' => 'まるぼん / まるほん / まるもと', 'level' => 3]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 9
        $vocabulary = Vocabulary::insertGetId(['word' => '医長','pronouce' => 'いちょう', 'level' => 4]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 10
        $vocabulary = Vocabulary::insertGetId(['word' => '分引き','pronouce' => 'ぶびき', 'level' => 4]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 11
        $vocabulary = Vocabulary::insertGetId(['word' => '以前','pronouce' => 'いぜん', 'level' => 4]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 12
        $vocabulary = Vocabulary::insertGetId(['word' => '生糸','pronouce' => 'きいと', 'level' => 3]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 13
        $vocabulary = Vocabulary::insertGetId(['word' => '羽化','pronouce' => 'うか', 'level' => 2]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 14
        $vocabulary = Vocabulary::insertGetId(['word' => '公算','pronouce' => 'こうさん', 'level' => 3]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 15
        $vocabulary = Vocabulary::insertGetId(['word' => '喫煙','pronouce' => 'きつえん', 'level' => 2]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 16
        $vocabulary = Vocabulary::insertGetId(['word' => '御中','pronouce' => 'おんちゅう', 'level' => 2]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 17
        $vocabulary = Vocabulary::insertGetId(['word' => '二形','pronouce' => 'ひとづき', 'level' => 2]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 18
        $vocabulary = Vocabulary::insertGetId(['word' => '三原','pronouce' => 'みはら', 'level' => 2]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 19
        $vocabulary = Vocabulary::insertGetId(['word' => '一戸','pronouce' => 'いっこ / いちこ', 'level' => 2]);
        ...
        $kanji->vocabularies()->attach($vocabulary);
        // 20
        $vocabulary = Vocabulary::insertGetId(['word' => '黄金','pronouce' => 'おうごん / こがね / きがね / くがね', 'level' => 2]);
